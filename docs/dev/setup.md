...
| Goal saving | `internal/httpapi/preferences_goals_test.go` | A client on the previous bundle sending the old goal shape and 400ing every save of every preference |
