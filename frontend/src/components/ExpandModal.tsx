 ...
 * else:
 *
 *   - it is portalled to the body, not merely fixed-positioned. Pages render
 *     inside the swipe pager, which is `position: relative; z-index: 1` — a
 *     stacking context — so a fixed child's z-index applies only *within the
 *     page* and the top and bottom bars stay on top of it however large the
 *     number is;
