...
describe('withoutDrafts', () => {
  it('drops a row that has no name yet', () => {
    const days: PlanDay[] = [{
      ...
      name: 'Chest',
      blocks: [
        { id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press', 'pe_1')] },
        { id: '', required: 1, restSec: 0, section: '', options: [ex('')] },
      ],
    }]
  ...
  it('drops an unnamed alternative without dropping its group', () => {
    const days: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press', 'pe_1'), ex('  ')] }],
    }]
  ...
  it('keeps a break that belongs to a real block', () => {
    const days: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 180, section: '', options: [ex('Bench press', 'pe_1')] }],
    }]
...
describe('adoptIds', () => {
  ...
  it('keeps a half-typed row that the server did not store', () => {
    const local: PlanDay[] = [{
      ...
      name: 'Chest',
      blocks: [
        { id: '', required: 1, restSec: 0, section: '', options: [ex('Bench press')] },
        { id: '', required: 1, restSec: 0, section: '', options: [ex('')] },
      ],
    }]
    const saved: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press', 'pe_1')] }],
    }]
  ...
  it('gives the saved rows their server ids', () => {
    const local: PlanDay[] = [{
      id: '',
      name: 'Chest',
      blocks: [{ id: '', required: 1, restSec: 0, section: '', options: [ex('Bench press'), ex('Push-ups')] }],
    }]
    const saved: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press', 'pe_1'), ex('Push-ups', 'pe_2')] }],
    }]
  ...
  it('lines rows up past a draft in the middle', () => {
    const local: PlanDay[] = [{
      ...
      blocks: [
        { id: '', required: 1, restSec: 0, section: '', options: [ex('Bench press')] },
        { id: '', required: 1, restSec: 0, section: '', options: [ex('')] },
        { id: '', required: 1, restSec: 0, section: '', options: [ex('Cable fly')] },
      ],
    }]
    const saved: PlanDay[] = [{
      id: 'pd_1',
      ...
      blocks: [
        { id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press', 'pe_1')] },
        { id: 'pb_2', required: 1, restSec: 0, section: '', options: [ex('Cable fly', 'pe_2')] },
      ],
    }]
  ...
  it('keeps what is typed rather than taking the server text back', () => {
    const local: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 0, section: '', options: [{ ...ex('Bench press throw', 'pe_1'), sets: 5 }] }],
    }]
    const saved: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
  ...
  it('leaves the tree alone when the server answered with nothing', () => {
    const local: PlanDay[] = [{ id: '', name: 'Chest', blocks: [{ id: '', required: 1, restSec: 0, section: '', options: [ex('Row')] }] }]
...
describe('isDraft and namesIn', () => {
  it('treats whitespace as no name', () => {
    expect(isDraft({ id: '', required: 1, restSec: 0, section: '', options: [ex('   ')] })).toBe(true)
    expect(isDraft({ id: '', required: 1, restSec: 0, section: '', options: [ex('Row')] })).toBe(false)
  })
  ...
  it('collects every name for the suggestion list', () => {
    const days: PlanDay[] = [{
      id: 'pd_1',
      name: 'Chest',
      blocks: [{ id: 'pb_1', required: 1, restSec: 0, section: '', options: [ex('Bench press'), ex('Push-ups')] }],
    }]
